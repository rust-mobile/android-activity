...
const _: () = {
    ["Size of GameActivityMotionEvent"]
        [::std::mem::size_of::<GameActivityMotionEvent>() - 1752usize];
    ...
    ["Offset of field: GameActivityMotionEvent::historicalEventTimesNanos"]
        [::std::mem::offset_of!(GameActivityMotionEvent, historicalEventTimesNanos) - 1732usize];
    ["Offset of field: GameActivityMotionEvent::historicalAxisValues"]
        [::std::mem::offset_of!(GameActivityMotionEvent, historicalAxisValues) - 1736usize];
    ["Offset of field: GameActivityMotionEvent::precisionX"]
        [::std::mem::offset_of!(GameActivityMotionEvent, precisionX) - 1740usize];
    ["Offset of field: GameActivityMotionEvent::precisionY"]
        [::std::mem::offset_of!(GameActivityMotionEvent, precisionY) - 1744usize];
};
unsafe extern "C" {
